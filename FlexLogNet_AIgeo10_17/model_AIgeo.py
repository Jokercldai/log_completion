...
class AggredGNN(MessagePassing):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.lin_key = Linear(gnn_out_channels, gnn_out_channels)  #gnn_in_channels[0]改为gnn_in_channels[1]更合适些
        self.lin_query = Linear(gnn_out_channels, gnn_out_channels)  #gnn_in_channels[0]改为gnn_in_channels[1]更合适些
...
class GraphNet(torch.nn.Module):             #这是将卷积应用到transformer中的版本
    ...
    def __init__(self,gnn_ch,batchsize,fea_litho,head,drop):
        ...
        CNN_ch = [4,32,64,128,256,512]  #[512,256,128,64,32]
